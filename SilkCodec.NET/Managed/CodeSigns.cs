 ...
 * @author Dingxin Xu
 */
internal class CodeSigns
{
    /* shifting avoids if-statement */
//    #define SKP_enc_map(a)                  ( SKP_RSHIFT( (a), 15 ) + 1 )
    internal static int SKP_enc_map(int a)
    {
        return (a>>15)+1;
    }

//    #define SKP_dec_map(a)                  ( SKP_LSHIFT( (a),  1 ) - 1 )
    internal static int SKP_dec_map(int a)
    {
        return (a<<1)-1;
    }
     ...
     */
    internal static void SKP_Silk_encode_signs(
...
//                inData = SKP_enc_map( q[ i ] ); /* - = 0, + = 1 */
     ...
     * @param RateLevelIndex Rate Level Index.
     */
    internal static void SKP_Silk_decode_signs(
            SKP_Silk_range_coder_state      sRC,               /* I/O  Range coder state                           */
...
//                q[ i ] *= SKP_dec_map( data );
                q[ i ] = unchecked((byte)((sbyte)q[i] * ((data << 1) - 1)));
            }
        }
    }
}
