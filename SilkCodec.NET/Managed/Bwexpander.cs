...
internal static class Bwexpander
{
     ...
     * @param chirp_Q16 Chirp factor (typically input the range 0 to 1).
     */
    internal static void SKP_Silk_bwexpander(
            short[] ar,        /* I/O  AR filter to be expanded (without leading 1)    */
            int        d,          /* I    Length of ar                                    */
            int              chirp_Q16   /* I    Chirp factor (typically input the range 0 to 1)    */
    )
    {
        int   i;
        ...
        /* Bias input SKP_SMULWB can lead to unstable filters                                */
        for( i = 0; i < d - 1; i++ ) {
