 ...
 * @author Dingxin Xu
 */
internal static class AnaFiltBank1
{
    /* Coefficients for 2-band filter bank based on first-order allpass filters */
    // old
    private static short[] A_fb1_20 = {  5394 << 1 };
    private static short[] A_fb1_21 = { unchecked((short)(20623 << 1)) };        /* wrap-around to negative number is intentional */
     ...
     */
    internal static void SKP_Silk_ana_filt_bank_1
    (
        short[] input,        /* I:   Input signal [N]        */
        int in_offset,
