 ...
 * @author Dingxin Xu
 */
internal static class FindPredCoefsFLP
{
    /************************
     * TEST for nlsf
     */
     ...
     */
    internal static void SKP_Silk_find_pred_coefs_FLP(
    ...
    )
    {
        ...
        {
            EncoderCompat.Assert( psEncCtrl.Gains[ i ] > 0.0f );
        ...
        if( psEncCtrl.sCmn.sigtype == SIG_TYPE_VOICED )
        {
            ...
            EncoderCompat.Fill(psEncCtrl.LTPCoef, 0, NB_SUBFR * LTP_ORDER, 0.0f);
