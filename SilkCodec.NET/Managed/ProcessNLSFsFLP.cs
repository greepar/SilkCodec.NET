 ...
 * @author Dingxin Xu
 */
internal static class ProcessNLSFsFLP
{
    /**
     * Limit, stabilize, convert and quantize NLSFs.
     ...
     */
    internal static void SKP_Silk_process_NLSFs_FLP(
    ...
    )
    {
        ...
        if( doInterpolate ) {
            ...
            Array.Copy(psEncCtrl.PredCoef[1], 0, psEncCtrl.PredCoef[0], 0, psEnc.sCmn.predictLPCOrder);
        }
    }
}
