 ...
 * @author Dingxin Xu
 */
internal static class PrefilterFLP
{
    /**
     ...
     */
    internal static void SKP_Silk_prefilter_FLP(
...
//            AR1_shp_offset = k * SHAPE_LPC_ORDER_MAX;
     ...
     * @param length
     */
    internal static void SKP_Silk_prefilt_FLP(
    ...
    )
    {
        ...
        for( i = 0; i < length; i++ ) {
            if( lag > 0 ) {
                EncoderCompat.Assert( HARM_SHAPE_FIR_TAPS == 3 );
