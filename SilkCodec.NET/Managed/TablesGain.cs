 ...
 * @author Dingxin Xu
 */
internal static class TablesGain
{
    internal static int[][] SKP_Silk_gain_CDF = {
            new int[] { 0, 18, 45, 94, 181, 320, 519, 777, 1093, 1468, 1909, 2417, 2997,
                    ...
                    65513, 65524, 65535 },
            new int[] { 0, 214, 581, 1261, 2376, 3920, 5742, 7632, 9449, 11157, 12780,
    ...
    internal const int SKP_Silk_gain_CDF_offset = 32;

    internal static int[] SKP_Silk_delta_gain_CDF = {
    ...
    internal const int SKP_Silk_delta_gain_CDF_offset = 5;
}
