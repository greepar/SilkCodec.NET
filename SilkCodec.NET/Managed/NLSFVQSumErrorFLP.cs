 ...
 * @author Dingxin Xu
 */
internal class NLSFVQSumErrorFLP
{
    /**
     * compute weighted quantization errors for LPC_order element input vectors, over one codebook stage.
     * @param err Weighted quantization errors [ N * K ]
     * @param input Input vectors [ N * LPC_order ]
     ...
     * @param LPC_order pCB
     */
    internal static void SKP_Silk_NLSF_VQ_sum_error_FLP(
              float                 []err,               /* O    Weighted quantization errors [ N * K ]  */
        float                 []input,                /* I    Input vectors [ N * LPC_order ]         */
        float                 []w,                 /* I    Weighting vectors [ N * LPC_order ]     */
    ...
    )
    {
        ...
        /* Copy to local stack */
        Array.Copy(w, 0, Wcpy, 0, LPC_order);
...
//TODO:
        ...
        if( LPC_order == 16 ) {
            ...
            System.Diagnostics.Debug.Assert( LPC_order == 10 );
