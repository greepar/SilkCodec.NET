 ...
 * @author Dingxin Xu
 */
internal static class Bwexpander32
{
    /**
     * Chirp (bandwidth expand) LP AR filter.
     * @param ar AR filter to be expanded (without leading 1).
     * @param d Length of ar.
     * @param chirp_Q16  Chirp factor input Q16.
     */
    internal static void SKP_Silk_bwexpander_32(
            int[] ar,      /* I/O    AR filter to be expanded (without leading 1)    */
            int  d,        /* I    Length of ar                                      */
            int        chirp_Q16 /* I    Chirp factor input Q16                               */
        )
    {
        int   i;
        int tmp_chirp_Q16;
