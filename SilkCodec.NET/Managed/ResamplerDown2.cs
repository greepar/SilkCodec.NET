 ...
 * @author Dingxin Xu
 */
internal static class ResamplerDown2
{
    /**
     * Downsample by a factor 2, mediocre quality.
     * @param S State vector [ 2 ].
     * @param S_offset offset of valid data.
     * @param output Output signal [ len ].
     * @param out_offset offset of valid data.
     * @param input Input signal [ floor(len/2) ].
     * @param in_offset offset of valid data.
     * @param inLen Number of input samples.
     */
    internal static void SKP_Silk_resampler_down2(
        int[] S,         /* I/O: State vector [ 2 ]                  */
        int S_offset,
        short[] output,       /* O:   Output signal [ len ]               */
        int out_offset,
        short[] input,        /* I:   Input signal [ floor(len/2) ]       */
        int in_offset,
