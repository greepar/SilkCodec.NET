 ...
 * @author Dingxin Xu
 */
internal static class TablesPulsesPerBlock
{
    internal static int[] SKP_Silk_max_pulses_table = {
             6,      8,     12,     18
    };

    internal static int[][] SKP_Silk_pulses_per_block_CDF  =
    {
    new int[] {
    ...
    internal const int SKP_Silk_pulses_per_block_CDF_offset = 6;

    internal static short[][]  SKP_Silk_pulses_per_block_BITS_Q6  =
    {
    new short[] {
    ...
    internal static int[][] SKP_Silk_rate_levels_CDF  =
    {
    new int[] {
    ...
    internal const int SKP_Silk_rate_levels_CDF_offset = 4;

    internal static short[][] SKP_Silk_rate_levels_BITS_Q6  =
    {
    new short[] {
    ...
    internal static int[] SKP_Silk_shell_code_table0 = {
    ...
    internal static int[]  SKP_Silk_shell_code_table1 = {
    ...
    internal static int[] SKP_Silk_shell_code_table2 = {
    ...
    internal static int[] SKP_Silk_shell_code_table3 = {
    ...
    internal static int[] SKP_Silk_shell_code_table_offsets = {
             0,      0,      3,      7,     12,     18,     25,     33,
