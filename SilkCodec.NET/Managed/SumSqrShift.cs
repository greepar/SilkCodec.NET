 ...
 * of int16s to make it fit input an int32
 *
 * @author Jing Dai
 * @author Dingxin Xu
 */
internal static class SumSqrShift
{
     ...
     */
    internal static void SKP_Silk_sum_sqr_shift(
        ...
        )
    {
        ...
        /* Make sure to have at least one extra leading zero (two leading zeros input total) */
        if( (nrg & 0xC0000000) != 0 ) {
            nrg = ( nrg >>> 2 );
            shft += 2;
        }
