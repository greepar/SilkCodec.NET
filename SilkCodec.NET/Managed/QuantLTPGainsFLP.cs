 ...
 * @author Dingxin Xu
 */
internal class QuantLTPGainsFLP
{
     ...
     */
    internal static void SKP_Silk_quant_LTP_gains_FLP(
        ...
        for( k = 0; k < 3; k++ ) {
            ...
            for( j = 0; j < NB_SUBFR; j++ ) {
                ...
                VQNearestNeighborFLP.SKP_Silk_VQ_WMat_EC_FLP(
                    ...
                    cbk_size                /* I    number of vectors input codebook                           */
                );
...
//                *periodicity_index = k;
            ...
            /* Break early input low-complexity mode if rate distortion is below threshold */
