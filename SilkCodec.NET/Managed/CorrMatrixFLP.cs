 ...
 * @author Dingxin Xu
 */
internal static class CorrMatrixFLP
{
    /**
     ...
     */
    internal static void SKP_Silk_corrVector_FLP(
        float[] x,                 /* I    x vector [L+order-1] used to create X   */
        int                         x_offset,
        float[] t,                 /* I    Target vector [L]                       */
        int                         t_offset,
        int                   L,                  /* I    Length of vecors                        */
     ...
     */
    internal static void SKP_Silk_corrMatrix_FLP(
        float[] x,                 /* I    x vector [ L+order-1 ] used to create X */
              int                   x_offset,
...
//            matrix_ptr( XX, j, j, Order ) = ( SKP_float )energy;
        ...
        for( lag = 1; lag < Order; lag++ ) {
            ...
            XX[XX_offset + lag * Order] = (float)energy;
            XX[XX_offset + lag] = (float)energy;
