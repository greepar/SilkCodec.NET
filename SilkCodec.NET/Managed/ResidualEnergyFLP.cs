 ...
 * @author Dingxin Xu
 */
internal static class ResidualEnergyFLP
{


    internal const int  MAX_ITERATIONS_RESIDUAL_NRG = 10;
    internal const float  REGULARIZATION_FACTOR = 1e-8f;
     ...
     */
    internal static float SKP_Silk_residual_energy_covar_FLP(           /* O    Weighted residual energy                */
...
//                    matrix_c_ptr( wXX, i, i, D ) +=  regularization;
     ...
     */
    internal static void SKP_Silk_residual_energy_FLP(
