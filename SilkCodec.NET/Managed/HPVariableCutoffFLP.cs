 ...
 * @author Dingxin Xu
 */
internal static class HPVariableCutoffFLP
{
    /**
     * TODO: TEST
     */
     ...
     * @param output High-pass filtered output signal
     * @param out_offset offset of valid data.
     * @param input Input signal
     * @param in_offset offset of valid data.
     */
    internal static void SKP_Silk_HP_variable_cutoff_FLP(
        SKP_Silk_encoder_state_FLP      psEnc,             /* I/O  Encoder state FLP                       */
        SKP_Silk_encoder_control_FLP    psEncCtrl,         /* I/O  Encoder control FLP                     */
              short[] output,               /* O    High-pass filtered output signal        */
              int out_offset,
    ...
    )
    {
        ...
        /*******************************/
        /* Compute cut-off frequency, input radians */
...
///*TEST END****************************************************************************/
        ...
        BiquadAlt.SKP_Silk_biquad_alt( input,in_offset, B_Q28, A_Q28, psEnc.sCmn.In_HP_State, output,out_offset, psEnc.sCmn.frame_length );
    }
}
