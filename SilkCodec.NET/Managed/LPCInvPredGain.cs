 ...
 * @author Dingxin Xu
 */
internal static class LPCInvPredGain
{
    internal static int  QA =          16;
    internal static int A_LIMIT =    65520;
     ...
     */
    internal static int SKP_Silk_LPC_inverse_pred_gain
    ...
    )
    {
        ...
        int[][] Atmp_QA = Array.ConvertAll(new int[2 ], _ => new int[SigProcFIX.SKP_Silk_MAX_ORDER_LPC ]);
        int tmp_QA;
        int[] Aold_QA, Anew_QA;
    ...
    /**
     * For input input Q13 domain.
     * @param invGain_Q30 Inverse prediction gain, Q30 energy domain.
     * @param A_Q13 Prediction coefficients, Q13 [order].
     * @param order Prediction order.
     * @return Returns 1 if unstable, otherwise 0.
     */
    internal static int SKP_Silk_LPC_inverse_pred_gain_Q13(   /* O:   Returns 1 if unstable, otherwise 0          */
            int[] invGain_Q30,           /* O:   Inverse prediction gain, Q30 energy domain  */
