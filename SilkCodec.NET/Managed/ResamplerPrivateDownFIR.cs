 ...
 * @author Dingxin Xu
 */
internal static class ResamplerPrivateDownFIR
{
    /**
     ...
     */
    internal static void SKP_Silk_resampler_private_down_FIR(
...
//        SKP_memcpy( buf2, S->sFIR, RESAMPLER_DOWN_ORDER_FIR * sizeof( SKP_int32 ) );
        ...
        while( true )
        {
            ...
            {
                /* Downsample 2x */
                ResamplerDown2.SKP_Silk_resampler_down2( S.sDown2,0, buf1,0, input,in_offset, nSamplesIn );
            ...
            {
                /* Second-order AR filter (output input Q8) */
                ResamplerPrivateAR2.SKP_Silk_resampler_private_AR2( S.sIIR,0, buf2,ResamplerRom.RESAMPLER_DOWN_ORDER_FIR, input,in_offset, S.Coefs,0, nSamplesIn );
            }
