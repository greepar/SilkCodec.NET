...
internal static class Sort
{
     ...
     */
    internal static void SKP_Silk_insertion_sort_increasing(
        ...
        )
    {
        ...
        /* Write start indices input index vector */
        for( i = 0; i < K; i++ ) {
            index[ i ] = i;
        }
     ...
     * @param K Number of correctly sorted positions
     */
    internal static void SKP_Silk_insertion_sort_decreasing(
            int[] a,             /* I/O: Unsorted / Sorted vector                */
            int[] index,         /* O:   Index vector for the sorted elements    */
            int       L,              /* I:   Vector length                           */
            int       K               /* I:   Number of correctly sorted positions    */
     ...
     * @param K Number of correctly sorted positions
     */
    internal static void SKP_Silk_insertion_sort_decreasing_int16(
     ...
     * @param L Vector length
     */
    internal static void SKP_Silk_insertion_sort_increasing_all_values(
            int[] a,             /* I/O: Unsorted / Sorted vector                */
            int                  a_offset,
            int         L               /* I:   Vector length                           */
        )
     ...
     * @param K Number of correctly sorted positions
     */
    internal static void SKP_Silk_shell_insertion_sort_increasing(
            int[] a,             /* I/O:  Unsorted / Sorted vector               */
            int[] index,         /* O:    Index vector for the sorted elements   */
            int       L,              /* I:    Vector length                          */
            int       K               /* I:    Number of correctly sorted positions   */
...
//            inc = SKP_RSHIFT_ROUND( inc_Q16_tmp, 16 );
     ...
     * @param L Vector length.
     */
    internal static void SKP_Silk_shell_sort_increasing_all_values(
            int[] a,             /* I/O:  Unsorted / Sorted vector               */
            int[] index,         /* O:    Index vector for the sorted elements   */
            int       L               /* I:    Vector length                          */
        )
