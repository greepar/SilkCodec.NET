...
internal static class SolveLSFLP
{
    /**
     * Function to solve linear equation Ax = b, when A is a MxM
     * symmetric square matrix - using LDL factorisation.
     * @param A Symmetric square matrix, output: reg.
     ...
     */
    internal static void SKP_Silk_solve_LDL_FLP(
              float[] A,                 /* I/O  Symmetric square matrix, output: reg.      */
              int                   A_offset,
...
//        SKP_Silk_SolveWithUpperTriangularFromLowerWdiagOnes_FLP( &L[ 0 ][ 0 ], M, T, x );
     ...
     * @param x_offset offset of valid data.
     */
    internal static void SKP_Silk_SolveWithUpperTriangularFromLowerWdiagOnes_FLP(
...
//            ptr1 =  matrix_adr( L, 0, i, M );
     ...
     * @param x x Vector
     */
    internal static void SKP_Silk_SolveWithLowerTriangularWdiagOnes_FLP(
        float[] L,     /* (I) Pointer to Lower Triangular Matrix */
...
//            ptr1 =  matrix_adr( L, i, 0, M );
     ...
     * Matrix D (only the diagonal elements returned input a vector)such that
     ...
     */
    internal static void SKP_Silk_LDL_FLP(
...
//                temp = matrix_ptr( A, j, j, M ); // element input row j column j
                ptr1 = L;
                ptr1_offset = j*M + 0;
