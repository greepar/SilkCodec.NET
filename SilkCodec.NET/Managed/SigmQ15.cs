 ...
 * @author Dingxin Xu
 */
internal static class SigmQ15
{
    /* fprintf(1, '%d, ', round(1024 * ([1 ./ (1 + exp(-(1:5))), 1] - 1 ./ (1 + exp(-(0:5)))))); */
    internal static int[] sigm_LUT_slope_Q10 =
    {
        237, 153, 73, 30, 12, 7
    };
    /* fprintf(1, '%d, ', round(32767 * 1 ./ (1 + exp(-(0:5))))); */
    internal static int[] sigm_LUT_pos_Q15 =
    {
        16384, 23955, 28861, 31213, 32178, 32548
    };
    /* fprintf(1, '%d, ', round(32767 * 1 ./ (1 + exp((0:5))))); */
    internal static int[] sigm_LUT_neg_Q15 =
    {
        16384, 8812, 3906, 1554, 589, 219
    };

    internal static int SKP_Silk_sigm_Q15( int in_Q5 )
    {
        int ind;
