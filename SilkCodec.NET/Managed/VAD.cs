...
internal static class VAD
{
     ...
     */
    internal static int SKP_Silk_VAD_Init(                              /* O    Return value, 0 if success                  */
...
//      SKP_memset( psSilk_VAD, 0, sizeof( SKP_Silk_VAD_state ) );
    ...
    internal static int[] tiltWeights = { 30000, 6000, -12000, -12000 };
     ...
     */
    internal static int SKP_Silk_VAD_GetSA_Q8(                                /* O    Return value, 0 if success      */
    ...
    )
    {
        ...
        /* Safety checks */
        EncoderCompat.Assert( VAD_N_BANDS == 4 );
        EncoderCompat.Assert( MAX_FRAME_LENGTH >= framelength );
        EncoderCompat.Assert( framelength <= 512 );
        ...
        for( b = 0; b < VAD_N_BANDS; b++ )
        {
            ...
            for( s = 0; s < VAD_INTERNAL_SUBFRAMES; s++ )
            {
                ...
                for( i = 0; i < dec_subframe_length; i++ )
                {
                    ...
                    /* Safety check */
                    EncoderCompat.Assert( sumSquared >= 0 );
                }
     ...
     * @param psSilk_VAD Silk VAD state.
     */
    internal static void SKP_Silk_VAD_GetNoiseLevels
    (
    ...
    )
    {
        ...
        for( k = 0; k < VAD_N_BANDS; k++ )
        {
            ...
            EncoderCompat.Assert( psSilk_VAD.inv_NL[ k ] >= 0 );
